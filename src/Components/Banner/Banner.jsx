...
const Banner = () => {
  return (
    <div className="py-12 rounded-2xl container mx-auto mt-8 mb-8 px-6 md:px-12 p-2 bg-gradient-to-b from-[#f5f5f5] to-white shadow-sm border-t-4 border-white border-x-3 border-white">
